  ...
  <div class="app-container">
    ...
    <div class="table-container">
      ...
      >
        ...
        <el-table-column label="类别名称" width="110" align="center">
          <template slot-scope="scope">
            {{ scope.row.typeName }}
          </template>
        </el-table-column>
...
<script>
import { getATList, deleteAT, updateAT, addAT } from '@/api/article_type'
